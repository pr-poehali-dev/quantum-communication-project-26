...
const events = [
  {
    ...
    desc: "В день памяти Равноапостольных Мефодия и Кирилла — просветителей Словенских — вся община храма совершила торжественный крестный ход вокруг церкви. Прихожане во главе с отцом настоятелем Петром обошли храм в молитве и духовной радости престольного праздника.",
